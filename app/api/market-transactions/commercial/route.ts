...
const BASE = "https://apis.data.go.kr/1613000/RTMSDataSvcNrgTrade";
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({
      ok: false,
      code: "COMMERCIAL_TRADE_UPSTREAM_ERROR",
      message: error instanceof Error ? error.message : "상업업무용 실거래가 조회 중 오류가 발생했습니다.",
    }, { status: 502 });
  }
}
